<template>
  <div>
    ...
    <b-row>
      <b-col cols="3" v-for="(item,index) of wishList" :key="index" class="p-0 mt-5 item_block">
        ...
        <span class="wishlist_block">
            <b-icon icon="heart-fill" variant="danger" @click="removeFromWishlist(item,wishListItemId)"  font-scale="1.5"  class="wishlist_icon"></b-icon>
        </span>
