  ...
  <div>
    <b-container class="bv-example-row w-50 mb-5">
      ...
      <b-form @submit.stop.prevent="onSubmit" class="checkour_form text-left">
        <b-row>
          <b-col>
            <b-form-group label="First Name" label-for="full_name">
              <b-form-input
                id="full_name"
                name="full_name"
                :class="{
                  'is-invalid': submitted && $v.form.full_name.$error,
                }"
                v-model="form.full_name"
              ></b-form-input>
              <div
                v-if="submitted && !$v.form.full_name.required"
            ...
            <b-form-group label="Confirm Password" label-for="confirm-password">
              <b-form-input
                ...
                type="password"
                :class="{
                  'is-invalid': submitted && $v.form.confirm_password.$error,
                }"
              ></b-form-input>
              <div
            ...
            <p class="btn d-inline">
              Already a member? <router-link to="/"> Sign in </router-link>
            </p>
            <hr />
