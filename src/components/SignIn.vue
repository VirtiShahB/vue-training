  ...
  methods: {
    ...
    login() {
      if (this.$store.state.user[0].email == null) {
        ...
        if ([this.email, this.password].includes(null)) {
          this.errorMsg = "Required email and password";
        } else {
          this.errorMsg = null;
          if (this.email != this.$store.state.user[0].email) {
            this.errorMsg = "No user found";
          } else {
            if (this.password != this.$store.state.user[0].password) {
