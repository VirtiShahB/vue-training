<template>
  <div>
    <h3 class="text-left">Checkout</h3><br>
      ...
      <b-row>
        <b-col>
          ...
          <b-form-group label="Country" label-for="country" >
            <b-form-select id="country" v-model="form.country" :options="country"></b-form-select>
          </b-form-group>
          ...
          <b-card class="text-center">
            <div>
              <b-table-simple class="checkout_table">
                ...
                <b-tbody>
                  <b-tr v-for="(c, index) of cart" :key="index" class="data_row">
                  ...
                  <b-tr>
                    ...
                    <b-td>
                      <b-form-checkbox-group v-model="form.shipping_type" id="shipping_type" >
                        <b-form-checkbox value="1">Free Shipping</b-form-checkbox>
                        <b-form-checkbox value="2">Local Pickup</b-form-checkbox>
